...
public class BasicInformationActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public BasicInformationActivity_ViewBinding(BasicInformationActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public BasicInformationActivity_ViewBinding(BasicInformationActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    BasicInformationActivity target = this.target;
